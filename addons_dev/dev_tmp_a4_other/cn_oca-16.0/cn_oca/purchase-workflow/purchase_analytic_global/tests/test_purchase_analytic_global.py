...
class TestPurchaseAnalyticGlobal(TransactionCase):
        ...
        cls.purchase_order1 = cls.purchase_order_model.create(
            {
                ...
                "analytic_distribution": cls.analytic_account1.id,
                "order_line": [
                    (
                        0,
                        0,
                ...
                "order_line": [
                    (
                        ...
                        0,
                        {
                            ...
                            "product_qty": 5,
                            "price_unit": 40,
                            "analytic_distribution": cls.analytic_account2.id,
                            "product_uom": cls.product.uom_id.id,
                            "date_planned": date.today(),
                        },
                    )
    ...
    def test_purchase_order_check(self):
        ...
        self.assertEqual(
            self.purchase_order2.analytic_distribution, self.analytic_account2
        )
