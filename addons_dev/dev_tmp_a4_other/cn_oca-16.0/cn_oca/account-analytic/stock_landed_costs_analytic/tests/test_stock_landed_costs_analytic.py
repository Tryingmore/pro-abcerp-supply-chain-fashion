...
class TestStockLandedCostsAnalytic(TransactionCase):
    def setUp(self):
        ...
        self.analytic_account_1 = dict(
            {str(self.env.ref("analytic.analytic_agrolait").id): 100.0})
        self.analytic_account_2 = dict(
        ...
        picking_vals = {
            ...
            "picking_type_id": self.Picking.picking_type_id,
            "location_id": self.Picking.location_id,
            ...
            "cost_lines": [
                (
                    ...
                    0,
                    {
                        ...
                        "analytic_distribution": self.analytic_account_1,
                    },
                ),
                (
                    0,
                    0,
                    {
                        ...
                        "analytic_distribution": self.analytic_account_2,
                    },
                ),
            ],
        }
    ...
    def test_stock_landed_costs_analytic(self):
        ...
        for line in self.landed_cost.account_move_id.line_ids:
            if line.account_id == self.account_1:
                self.assertEqual(line.analytic_distribution, self.analytic_account_1)
            if line.account_id == self.account_2:
                self.assertEqual(line.analytic_distribution, self.analytic_account_2)
