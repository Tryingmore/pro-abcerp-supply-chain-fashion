...
.. |badge4| image:: https://img.shields.io/badge/weblate-Translate%20me-F47D42.png
    :target: https://translation.odoo-community.org/projects/account-analytic-16-0/account-analytic-14-0-stock_analytic
...
To Assign an analytic distribution to a Stock Move
==============================================

You need to:

#. Create manually or open draft picking
#. Add move lines and fill **analytic distribution**  fields

Assigned Journal Items created from Stock Move with analytic distribution
=========================================================================
...
#. Journal item with account equal to product's valuation account will not be
   assigned to any analytic distribution
#. Journal item with account different to product's valuation account will be
   assigned to an analytic distribution according to the stock move's analytic
   account. .
