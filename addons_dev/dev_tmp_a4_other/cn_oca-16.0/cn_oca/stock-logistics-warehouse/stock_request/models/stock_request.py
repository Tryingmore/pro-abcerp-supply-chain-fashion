...
class StockRequest(models.Model):
    ...
    company_id = fields.Many2one("res.company",states={"draft": [("readonly", False)]}, readonly=True)
    route_id = fields.Many2one("stock.route",states={"draft": [("readonly", False)]}, readonly=True)
